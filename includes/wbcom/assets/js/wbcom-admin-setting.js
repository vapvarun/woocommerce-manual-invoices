...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        jQuery(document).on(
            "change",
            "#bpvendor-favourite-product-tab-slug",
            function () {
                var str = $('#bpvendor-favourite-product-tab-slug').val();
                if (/^[a-z- ]*$/.test(str) == false) {
                    $('#bp_fav_product_tag_slug').show();
                    $('#bpvendor-favourite-product-tab-slug').val('favourite-products');
                } else {
                    $('#bp_fav_product_tag_slug').hide();
                }
        ...
        jQuery(document).on(
            "change",
            "#buddyvendor-product-tab-slug",
            function () {
                var str = $('#buddyvendor-product-tab-slug').val();
                if (/^[a-z- ]*$/.test(str) == false) {
                    $('#buddyvendor_product_tag_slug').show();
                    $('#buddyvendor-product-tab-slug').val('products');
                } else {
                    $('#buddyvendor_product_tag_slug').hide();
                }
